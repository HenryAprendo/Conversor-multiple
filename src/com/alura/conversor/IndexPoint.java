...
public class IndexPoint {
	...
	public static void main(String[] args) {
		...
		while (seguir) {
			...
			String seleccion = Conversor.seleccionarItem("Seleccione una opción de conversión", "Menu",
			...
			try {
				...
				if (esValido) {
					...
					// Opciones de cambio
					String opcionSeleccionada = conversor.seleccionarTipoCambio(tipo, titulo, JOptionPane.DEFAULT_OPTION,
							posibilidades);
				...
				e.printStackTrace();
				int terminar = Conversor.terminarProgramaValorNulo();
				if (terminar != 0) {
					seguir = false;
				}
